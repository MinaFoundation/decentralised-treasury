...
export const defaultTreasuryIntlMessages: Record<string, string> = {
  ...
  "ui.footer.apiHealth": "API",
  "ui.footer.indexerHealth": "Indexer",
  "ui.footer.liveSlot": "Chain",
  "ui.footer.liveBlock": "Live block",
  "ui.footer.indexedSlot": "Indexed",
  "ui.footer.indexedBlock": "Indexed block",
  "ui.footer.slotLag": "Lag",
  "ui.footer.updatedAt": "Updated",
  "ui.footer.health.healthy": "Healthy",
  "ui.footer.health.degraded": "Degraded",
  "ui.footer.health.down": "Down",
  "ui.footer.health.unknown": "Unknown",
