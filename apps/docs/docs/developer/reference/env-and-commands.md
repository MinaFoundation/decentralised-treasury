---
title: Environment and Commands
sidebar_label: Environment and Commands
---

This page collects commands, environment variables, storage notes, and a compact code map. Start with [Overview](../provable/provable-overview.md) or [Architecture](../provable/provable-architecture.md) if you need the subsystem context first.
...
- [Overview](../provable/provable-overview.md)
- [Architecture](../provable/provable-architecture.md)
